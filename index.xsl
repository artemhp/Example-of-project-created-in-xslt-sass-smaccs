            ...
            <div class="company">
                ...
                <ul>
                    <xsl:for-each select="//portfolio//company/item[not(.=following::item)]">
                        ...
                        <li>
                            <span class="count">
                                <xsl:value-of select="count(//portfolio//company[item = $item])"/>
                            </span>
                            <span class="select">
                                <xsl:value-of select="."/>
                            </span>
            ...
            <div class="year">
                ...
                <ul>
                    <xsl:for-each select="//portfolio//year/item[not(.=following::item)]">
                        ...
                        <li>
                            <span class="count">
                                <xsl:value-of select="count(//portfolio//year[item = $item])"/>
                            </span>
                            <span class="select">
                                <xsl:value-of select="."/>
                            </span>
            ...
            <div class="role">
                ...
                <ul>
                    <xsl:for-each select="//portfolio//role/item[not(.=following::item)]">
                        ...
                        <li>
                            <span class="count">
                                <xsl:value-of select="count(//portfolio//role[item = $item])"/>
                            </span>
                            <span class="select">
                                <xsl:value-of select="."/>
                            </span>
            ...
            <div class="tools">
                ...
                <ul>
                    <xsl:for-each select="//portfolio//tools/item[not(.=following::item)]">
                        ...
                        <li>
                            <span class="count">
                                <xsl:value-of select="count(//portfolio//tools[item = $item])"/>
                            </span>
                            <span class="select">
                                <xsl:value-of select="."/>
                            </span>
